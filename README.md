...
Cross-references design documents against the codebase. Every design decision is classified as **Implemented**, **Not implemented**, or **Mismatch**. Supports incremental updates via `git diff`.
...
│   │       ├── data-model.md
│   │       └── pipeline.md
│   ├── design-map.md             ← generated by /design-map
