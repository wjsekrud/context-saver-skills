...
Spawns parallel agents to read all markdown files and produces a structured briefing with per-document summaries, "read this when" conditions, cross-references, and a quick reference table.
...
Output: `.claude/docs-briefing.md`
...
│   │   └── delegate/
│   │       └── SKILL.md
│   ├── docs-briefing.md          ← generated by /explore-docs
